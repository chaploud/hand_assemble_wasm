(module
  ...
  ;; Start function
  (func (export "_start")
    ;; Compare two integers using various comparison operators
    (if (i32.eq (i32.const 10) (i32.const 5))
      (then (call $print_int (i32.const 1)))
      (else (call $print_int (i32.const 0))))

    (if (i32.lt_s (i32.const 10) (i32.const 5))
      (then (call $print_int (i32.const 1)))
      (else (call $print_int (i32.const 0))))

    (if (i32.le_s (i32.const 10) (i32.const 5))
      (then (call $print_int (i32.const 1)))
      (else (call $print_int (i32.const 0))))
    ...
    (if (i32.ge_s (i32.const 10) (i32.const 5))
      (then (call $print_int (i32.const 1)))
      (else (call $print_int (i32.const 0))))

    (if (i32.ne (i32.const 10) (i32.const 5))
      (then (call $print_int (i32.const 1)))
      (else (call $print_int (i32.const 0))))
  )
)
